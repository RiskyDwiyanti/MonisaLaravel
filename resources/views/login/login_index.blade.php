	...
	<body id="kt_body" class="bg-body">
				...
				<div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative" style="background-color: #F2C98A">
					...
					<div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
						...
						<div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
							...
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="fw-bolder fs-2qx pb-5 pb-md-10" style="color: #986923;">Welcome to Monisa</h1>
							<!--end::Title-->
							<!--begin::Description-->
						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
							...
							<form class="form w-100" id="kt_sign_in_form" method="POST" action="{{ route('auth.login') }}">
								...
								<div class="text-center mb-10">
									<!--begin::Title-->
									<h1 class="text-dark mb-3">Sign In to Monisa</h1>
									<!--end::Title-->
								</div>
								<!--begin::Heading-->
								<!--begin::Input group-->
								...
								<div class="fv-row mb-10">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input class="form-control form-control-lg" type="password" name="password" id="password" autocomplete="off" />
                                    </div>
									<!--end::Input-->
								</div>
								<!--end::Input group-->
        ...
        function togglePassword() {
            ...
            if (password.type === "password") {
                password.type = "text";
                $('#toggleIcon').removeClass("bi bi-eye-fill");
                $('#toggleIcon').addClass('bi bi-eye-slash-fill');
            } else {
                password.type = "password";
                $('#toggleIcon').removeClass('bi bi-eye-slash-fill');
                $('#toggleIcon').addClass("bi bi-eye-fill");
            }
        }
        ...
        function signIn(){
            ...
            $.ajax({
                url: "",   // endpoint Laravel (UserAjaxController@index)
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                    ...
                    if(xhr.status === 422){
                        ...
                        for(let field in res.errors){
                            res.errors[field].forEach(msg => {
                                errorList += `<li style="font-size:16px;">${msg.en} <br><small>(${msg.id})</small></li>`;
                            });
                        }
                        errorList += "</ul>";
                        ...
                        Swal.fire({
                            icon: "warning",
                            title: `<div style="font-size:20px; font-weight:bold;">
                                ${res.message.en}
                                <small style="font-size:13px; color:#666;">(${res.message.id})</small>
                            </div>`,
                            html: errorList
                        });
                    }else{
